    ...
    public VehicleForm() {
        addButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent event) {
                ...
                managerVehicle.create(new Vehicle(textFieldLicence.getText(), dateChooserStart.getDate(), ((OwnerContainer) comboBoxOwner.getSelectedItem()).owner, Type.LIGHT, ((ModelContainer) comboBoxModel.getSelectedItem()).model));
